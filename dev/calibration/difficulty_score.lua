...
-- REAPER project. See _future_ideas/general_difficulty_suggester.md for the
-- design and for why each factor exists.
--
-- Status: calibration pilot. Lives under dev/ until the factors are validated
-- against the reference corpus; moves into the helper only if they hold up.
--
-- ---------------------------------------------------------------------------
-- Input contract
--
