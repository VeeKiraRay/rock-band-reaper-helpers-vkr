...
--
--   v1.20
--     - The window title now carries the script version - "Rock Band Vocal
--       Helper v1.20". A bug report that quotes the title says which version
...
WINDOW_TITLE = ScriptWindowTitle('Rock Band Vocal Helper', _script)
